...
HRESULT DebugText::Init(DirectX11& pDx11 )
{
	m_pDx11 = &pDx11;
...
//===========================================================
HRESULT DebugText::CreateShader()
{
...
//テクスチャ作成.
HRESULT DebugText::CreateTexture( LPCTSTR lpFileName )
{
	//テクスチャ作成.
...
//サンプラ作成.
HRESULT DebugText::CreateSampler()
{
	//テクスチャ用のサンプラ構造体.
...
//フォントレンダリング
void DebugText::RenderFont(int FontIndex, float x, float y)
{
	//ワールド行列.
	D3DXMATRIX	mWorld;
...
//レンダリング用.
void DebugText::Render(LPCTSTR text, int x, int y)
{
	//使用するシェーダの登録.
